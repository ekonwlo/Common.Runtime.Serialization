...
namespace Common.Runtime.Serialization.IntegTests.Json
{
    ...
    public class JPrimitiveSerializerIntegTest
    {
        private readonly ISerializer[] _serializers = new JSerializerFactory().Create<TestPropertyAttribute>(typeof(TestChildClass));
        ...
        // Setup
        public JPrimitiveSerializerIntegTest()
        {
        ...
        public void ShouldSetProperty()
        {
            ...
            _floatSerializer.SetProperty<string>(o, "2345.0");
            _doubleSerializer.SetProperty<string>(o, "3454575667868.0");
        ...
        public void ShouldGetProperty()
        {
            ...
            Assert.Equal("164564.0", _floatSerializer.GetProperty<string>(o));
            Assert.Equal("16675567567557.0", _doubleSerializer.GetProperty<string>(o));
        }

        [Fact(DisplayName = "should parse to string")]
        public void ShouldParseToString()
        {
            Assert.Equal("null", _stringSerializer.To<string>(null));
            ...
            Assert.Equal(String.Format(CultureInfo.GetCultureInfo("en-GB"), "{0:0.0}", 200f)
               , _floatSerializer.To<string>(200f));
            Assert.Equal(String.Format(CultureInfo.GetCultureInfo("en-GB"), "{0:0.0}", 400d)
        ...
        public void ShouldParseFromString()
        {
            ...
            Assert.Equal(4568767868f, _floatSerializer.From<string>(String.Format(CultureInfo.GetCultureInfo("en-GB"), "{0:0.0}", 4568767868f)));
            Assert.Equal(456876786869894d, _doubleSerializer.From<string>(String.Format(CultureInfo.GetCultureInfo("en-GB"), "{0:0.0}", 456876786869894d)));
        }
