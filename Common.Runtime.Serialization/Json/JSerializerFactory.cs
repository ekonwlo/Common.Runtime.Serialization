...
namespace Common.Runtime.Serialization.Json
{
        ...
        : SerializerFactory<JToken>
    {
		...
		public override ISerializer<JToken> CreateArrayConverter(TypeDefinition baseType, PropertyInfo property, ISerializableProperty attribute, string format, Transformator transformator, ISerializer<JToken> serializer)
        {
