...
namespace Common.Runtime.Serialization.Json
{
    ...
    {
        internal JNullableSerializer(SerializerFactory<JToken> factory, Type type, PropertyInfo property, ISerializableProperty attribute, string format, Transformator transformator)
